...
handlers = [
    ...
    (r"/admin/edit/article/(\d+)", EditArticleHandler),
    (r"/admin/edit/delete/article/(\d+)", DelArticleHandler),
    ("/admin/edit/new/page", NewPageHandler),
    (r"/admin/edit/page/(\d+)", EditPageHandler),
    (r"/admin/edit/delete/page/(\d+)", DelPageHandler),
    (r".*", PageNotFound),
]
